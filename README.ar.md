...
> أداة لتحويل كتب [المكتبة الشاملة](https://shamela.ws) إلى ملفات EPUB محليًا، ومتاحة كإضافة متصفح وتطبيق سطح مكتب وتطبيق أندرويد.
...
- **محول BOK محلي**: فتح ملفات `.bok` محليًا وتحليل المحتوى قبل التصدير.
- معاينة الكتاب والأجزاء قبل البدء.
- التصدير إلى EPUB أو PDF أو HTML.
- تحويل دفعات متعددة من كتب BOK في تشغيل واحد.
- ملفات EPUB الناتجة من BOK متوافقة مع EPUBCheck وبنتائج أكثر ثباتًا.
- نافذة الحفظ في تطبيق سطح المكتب تدعم مرشح ZIP.
